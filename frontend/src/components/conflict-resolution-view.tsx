        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              ...
              <th className="text-left px-4 py-2 font-medium text-gray-600">Reviewer Values</th>
          ...
          <tbody className="divide-y divide-gray-100">
            {conflicts.map((conflict) => (
              <tr key={conflict.field}>
                <td className="px-4 py-3 font-mono text-xs text-gray-700">{conflict.field}</td>
                ...
                <td className="px-4 py-3">
                  {resolutions[conflict.field] ? (
                    ...
                    <span className="text-xs text-gray-400">Select a value</span>
                  )}
                </td>
              </tr>
            ))}
